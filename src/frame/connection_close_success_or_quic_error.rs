...
#[derive(Clone, Debug)]
pub struct ConnectionCloseSuccessOrQuicError
{
...
impl ConnectionCloseSuccessOrQuicError
{
    pub fn new(
        error_code:           VariableLengthInteger,
        error_frame_type:     Option<VariableLengthInteger>,
    ...
    {
        Self {
            frame_type: VariableLengthInteger::from(FrameType::ConnectionCloseSuccessOrQuicError),
            error_code,
            error_frame_type,

...
const VARIABLE_LENGTH_U32_BIT_SETTING_MASK: u32 = 0x8000_0000;
const VARIABLE_LENGTH_U32_BIT_CLEARING_MASK: u32 = 0x3FFF_FFFF;
...
impl VariableLengthEncodedU32
{
    /// If a value is too large, this method will return Err.
    pub(crate) fn try_new_from_decoded_value(decoded_value: u32) -> anyhow::Result<Self>
    {
    ...
    pub(crate) fn new_from_encoded_value(encoded_value: u32) -> Self
    {
    ...
    pub fn decoded_value(&self) -> u32
    {
        self.decoded_value
    }

    pub fn encoded_value(&self) -> u32
    {
        self.encoded_value
    }
}
